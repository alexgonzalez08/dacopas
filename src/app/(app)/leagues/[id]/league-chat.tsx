...
export default function LeagueChat({
  ...
  return (
    <>
      ...
      <button
        onClick={handleOpen}
        className="fixed top-1/2 -translate-y-1/2 left-0 z-40 w-14 h-14 rounded-full bg-sky-400 hover:bg-sky-300 text-white shadow-lg flex items-center justify-center transition relative"
