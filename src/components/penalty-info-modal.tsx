...
const STEPS = [
  {
    emoji: '🥅',
    title: '¡Nueva función: Penales!',
    text: 'A partir de la Ronda de 32, los partidos que terminen empatados van a penales. Ahora podés pronosticar quién gana en la tanda de penales.',
  },
  {
    emoji: '🎯',
    title: '¿Cómo funciona?',
    text: 'Si ingresás un marcador empatado en un partido eliminatorio, aparecerán dos indicadores arriba del marcador para elegir el ganador en penales. Seleccioná el equipo que creés que gana.',
  },
  {
    emoji: '⭐',
    title: '¿Cuántos puntos suma?',
    text: 'Marcador exacto + penales correctos → 5 puntos 🔥\nSolo penales correctos (marcador incorrecto) → 3 puntos\nMarcador exacto + penales incorrectos → 3 puntos\nGanador correcto sin empate → 1 punto',
  },
]
...
export default function PenaltyInfoModal({
  ...
  function handleClose() {
    ...
    supabase.from('profiles').update({ penalty_info_seen: true }).eq('id', userId).then()
  }
